...
\begin{minipage}[t]{0.45\textwidth} % 27.5% of the page width for the first row of icons
	...
	\icon{MapMarker}{12}{New York, NY}\\
	\icon{Phone}{12}{(505) 396-9966}\\
	\icon{At}{12}{\href{mailto:alyx@vance.me}{yyt@iotatechsys.com}}\\	
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth} % 40% of the page width for the introduction text
	...
	We are a minority and women-owned small business with a passion for clean, performant, and sustainable code. Our team represents decades of experience in building industry-leading software solutions at scale, with expertise in software development, system architecture, testing, database management, cloud orchestration, security, and data analytics. % Dummy text
\end{minipage}
\hfill % Whitespace between
\begin{minipage}[t]{0.5\textwidth} % 50% of the page for the skills bar chart
	\vspace{-\baselineskip} % Required for vertically aligning minipages
 	\cvsect{Core Competence}

	\begin{barchart}{5.5}
		\baritem{Software Dev}{60}
		\baritem{Data Science}{40}
		\baritem{Migration}{50}
		\baritem{Compliance}{50}
		\baritem{Git}{50}
		\baritem{LaTeX}{50}
	\end{barchart}
\end{minipage}
